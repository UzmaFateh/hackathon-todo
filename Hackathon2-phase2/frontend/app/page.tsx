      ...
      <div className="min-h-screen pb-12 font-sans">
        ...
        <header className="glass-panel sticky top-4 mx-4 mb-8 z-10 px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-primary-500/20">
              T
            </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-gray-400 bg-white/5 hover:bg-white/10 hover:text-error-400 rounded-lg transition-all border border-transparent hover:border-error-900/30"
            >
              Sign Out
            </button>
          </div>
        ...
        <main className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 space-y-6">
              {/* Search & Sort */}
              {/* This section is now integrated into the Filters Panel */}
              ...
              <div className="space-y-4">
                {tasksApi.loading ? (
                  ...
                  <div className="glass-panel p-12 text-center">
                    <div className="w-20 h-20 bg-primary-900/20 rounded-full flex items-center justify-center mx-auto mb-4">
